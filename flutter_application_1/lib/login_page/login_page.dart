...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                          ...
                          child: Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    'เข้าส่ระบบเพื่อเข้าใช้งาน',
                                    style: TextStyle(color: Color.fromARGB(255, 119, 36, 235)),
                                  ),
                                        ...
                                        children: [
                                              ...
                                              child: Padding(
                                                ...
                                                child: Text(
                                                  ...
                                                  style: TextStyle(
                                                      ...
                                                      fontWeight:
                                                          FontWeight.bold,
                                                      color: Color.fromARGB(255, 244, 240, 248)),
                                                ),
                                              ),
                                              onPressed: () {
                                          ...
                                          Container(
                                            ...
                                            child:
                                              ...
                                              TextSpan(
                                                text: 'กดที่นี่เพื่อสร้างแอคเคาท์',
                                                recognizer:
      ...
      backgroundColor: Color.fromARGB(255, 194, 197, 239),
    );
  }
    ...
    try {
      ...
      if (e.toString() ==
        ...
        Fluttertoast.showToast(
            ...
            textColor: Color.fromARGB(255, 251, 237, 237),
            fontSize: 16.0);
      } else if (e.toString() ==
        ...
        Fluttertoast.showToast(
            ...
            gravity: ToastGravity.BOTTOM,
            timeInSecForIosWeb: 1,
            backgroundColor: Color.fromARGB(255, 246, 18, 181),
